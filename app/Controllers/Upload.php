...
class Upload extends BaseController
{
	...
	public function index()
    {
        if (!$this->validate([]))
        {
            ...
            $data['/uploads/1'] = $this->model_upload2->get_uploads();
    ...
    public function process()
    {
        ...
        $validated = $this->validate([
            ...
            'foto'        => 'uploaded[file_upload]|mime_in[file_upload,image/jpg,image/jpeg,image/gif,image/png]|max_size[file_upload,4096]'
        ]);
        ...
        if ($validated == FALSE) {
            ...
            $avatar->move(ROOTPATH . 'public/uploads/1');

            $data = [
                'foto' => $avatar->getName(),
                'foto_ktp' => $avatar->getName(),
            ...
            $this->model_upload2->insert_gambar($data);
